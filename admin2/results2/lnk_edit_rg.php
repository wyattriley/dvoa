...
if (isset($_POST['action'])) {
	...
	$db->delete('result_lnk',"sked_id=%i AND lnk_type=2",$sked_id);
...
$title = sprintf("[%d] DVOA %s (%s) Add/Modify RouteGadget Links",$sked_id,$ev_name,FormatDate($ev_date));
?>
...
<div id="wrapper">
	<div id="header">
		...
		<h2>RouteGadget - Links Validation</h2>
	</div>
	<?php
	GetUserBar();
	?>
	...
	<div id="content">
		...
		<div class="frm_wrap">
			...
			<form method="post" action="">
				...
				?>
					<div class="item">
						<div class="titles"><?php printf("<p><strong>RG Link %d:</strong></p><br />\n",$cnt++);?></div>
						<div class="inner_wrap">
							<div class="inputs">
							<?php
