...
<div id="wrap">
	...
	<div id="infopane">
		...
		<div id="rightcol">
			...
			if ($dbgen->count() > 0) {
				foreach ($rs as $row) {
					$routegadget2url = str_replace("cgi/gadget/reitti.cgi?act=map&id=","gadget/rg2/#",$row["url"]);
					printf("<div class=\"lnks\"><a href=\"$routegadget2url\">RouteGadget2</a>\n");
					//https://www.dvoa.org/cgi/gadget/reitti.cgi?act=map&id=560
					//https://www.dvoa.org/gadget/rg2/#560
