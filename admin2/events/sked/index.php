...
<p>We use <b>online preregistration</b> for all of our events (at a significant <b>discount</b> versus day-of-event rates.)
Links to register are listed below. Deadline to register is normally the Thursday before the event. </p>
<p>Walk in <b>day-of-event registration is available</b> unless otherwise noted, but map/course selection may be limited.
Cost for registering at the event is $10/map for the white/beginner course and $20/map for all other courses. </p>
<p><a href="#risks">See below</a> for a note about risks you assume while orienteering, including Covid-19 information.</p>
		...
		foreach ($rs as $row) {
            ...
            if (strlen($row['regurl']) > 1) {
				printf("<br /><a target=\"_blank\" href=\"%s\" style=\"color:red;\"><strong>Pre-register Here</strong></a>",$row['regurl']);
				$whos_registered_url = str_replace("register/start","reglist/home",$row['regurl']);
				printf(" or <a target=\"_blank\" href=\"%s\">Check Who's Registered</a>",$whos_registered_url);
			}
 ...
 <!-- CD-19 notice -->
        <div style="border:1px solid red;padding:10px; background-color:#eee; box-shadow:2px 2px 2px #666; margin:12px 0;" id="risks">
    <div>
      <div>
        <blockquote type="cite">
          <div dir="ltr"> 
            ...
            <ul>
            <li>Outdoor activies, including Orienteering have some inherent risks, and we ask that you assume those risks when you are out and about.  These risks include both physical hazards, such as the rocks, stick and logs in our parks, as well as a risk of catching something from another person outside, including Covid-19.
            <li>For a more isolated orienteering experience - our<a href="http://dvoa.org/learn/perm/index.php" shape="rect" rel="nofollow"><strong> Permanent Courses</strong></a> await you any time*. (*Check with the specific park for their opening hours.)</li>
            ...
            <li><strong>Mask usage:</strong> Please continue to respect other Orienteers & Volunteers who have different COVID strategies than you do.  At our registration, check-in and download areas in particular, please be respectful and keep your distance and/or wear your mask if they are masked.</li>
            ...
            <li><strong>Online-pre-registration:</strong> watch for the deadlines a day or two before the event.  Pre-registration ensures there will be a map available for you, and is significantly discounted vs. day-of rates.</li>
            <li>If you miss the pre-registration, onsite registration is generally available (without the discount), and you can check with the Event Director to confirm. </li>
